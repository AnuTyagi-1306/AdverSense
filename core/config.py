"""Configuration and constants for AdverSense (Machine Learning-Powered Pharmacovigilance Intelligence Platform).
...
# Color palette for visualizations (matches .streamlit/config.toml theme)
PALETTE = {
    "primary": "#00B4D8",      # Teal accent from config
    "secondary": "#0096C7",    # Darker teal
    "accent": "#48CAE4",       # Lighter teal
    "neutral": "#90E0EF",      # Very light teal
    "purple": "#8B5CF6",       # Purple for contrast
    "cyan": "#22D3EE",         # Cyan accent
    "orange": "#FB923C",       # Orange for warnings
}
